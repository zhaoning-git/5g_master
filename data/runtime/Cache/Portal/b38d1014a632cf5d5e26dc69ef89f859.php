...
<!--    <div class="log"><img src="/public/index/images/log.png"></div>-->
    ...
    <div class="button">
        <a class="ios" href="#"><img src="/public/index/images/ios2.png"></a>
        <a class="ios display" href="#"><img src="/public/index/images/ios.png"></a>
        <a class="adr" href="#"><img src="/public/index/images/adr2.png"></a>
        <a class="adr display" href="#"><img src="/public/index/images/adr.png"></a>
    </div>
    <div class="foot">
        <div></div>
