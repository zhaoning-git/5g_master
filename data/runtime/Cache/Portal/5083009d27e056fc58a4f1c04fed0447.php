...
<body>
	...
	<div class="wrap js-check-wrap">
		...
		<form class="well form-search" method="post" action="<?php echo U('AdminPage/index');?>">
			...
			<select name="type">
				<option value="0" <?php if($formget["type"] == 1): ?>selected<?php endif; ?>>单页面</option>
				<option value="2" <?php if($formget["type"] == 2): ?>selected<?php endif; ?>>关于我们</option>
				<option value="3" <?php if($formget["type"] == 3): ?>selected<?php endif; ?>>活动页面</option>
			</select>
		...
		<form class="js-ajax-form" method="post">
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><tr>
					...
					<td>
						<?php if($vo['type'] == 0): ?>单页面<?php endif; ?> 
						<?php if($vo['type'] == 2): ?>关于我们<?php endif; ?>
						<?php if($vo['type'] == 3): ?>活动页面<?php endif; ?>
					</td>
					...
					<td>
                        ...
                        <?php if(!in_array(($vo['id']), explode(',',"2,3,4,5,10,18"))): ?><a href="<?php echo U('AdminPage/delete',array('id'=>$vo['id']));?>" class="js-ajax-delete"><?php echo L('DELETE');?></a><?php endif; ?>
