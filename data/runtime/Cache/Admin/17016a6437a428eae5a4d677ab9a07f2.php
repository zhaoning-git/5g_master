        ...
        <form method="post" class="js-ajax-form" action="<?php echo U('Gift/listorders');?>">
            ...
            <table class="table table-hover table-bordered">
                ...
                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                        ...
                        <td><?php echo ($vo["yonmobile"]); ?></td>
                        <td><img src="<?php echo C('url'); echo ($vo["cardselfs"]); ?>" id="thumb1_preview" width="50" style="cursor: hand" /></td>
                    ...
                    <a href="<?php echo U('Organicon/wemedit',array('id'=>$vo['ids']));?>" >编辑</a>
                    |
                    <a href="<?php echo U('Order/del',array('id'=>$vo.ids));?>" class="js-ajax-dialog-btn" data-msg="您确定要删除吗？">删除</a>
                    </td>
