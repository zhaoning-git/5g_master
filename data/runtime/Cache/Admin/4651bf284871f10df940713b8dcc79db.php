...
<body>
	...
	<div class="wrap">
		...
		<ul class="nav nav-tabs">
			...
			<li><a href="<?php echo U('Clubs/add_type');?>">添加标签分类</a></li>
				...
				<tbody>
					...
					<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
						...
						<td>
							...
							<?php if($vo['type'] == 4): ?>俱乐部首页标签

								<?php else: ?>热聊标签<?php endif; ?>
						...
						<td align="center">
							...
							<a href="<?php echo U('Clubs/edit_type',array('id'=>$vo['id'],'type'=>'edit'));?>">编辑</a>
...
<script type="text/javascript">
    var url = "<?php echo U('Clubs/typeList');?>";
     laypage({
