...
<body>
  ...
  <div class="wrap">
    ...
    <form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Goods/adds');?>">
      ...
      <fieldset>
        ...
        <div class="control-group">
          ...
          <div class="controls">
           ...
           <td>  隐藏 <input type="radio" name="status" value="1"></td>
           <td> 显示 <input type="radio" name="status" value="0"></td>
            <span class="form-required">*</span>
