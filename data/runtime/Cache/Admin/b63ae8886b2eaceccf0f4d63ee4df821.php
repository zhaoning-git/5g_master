...
<body>
	...
	<div class="wrap">
		...
		<ul class="nav nav-tabs">
			...
			<li><a href="<?php echo U('HomeConfig/index');?>">房间列表</a></li>

			<li class="active"><a>添加房间</a></li>

			

		</ul>

		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('HomeConfig/add');?>">
