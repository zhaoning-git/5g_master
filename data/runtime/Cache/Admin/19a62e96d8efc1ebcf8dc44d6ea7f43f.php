    ...
    <form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Config/set_post');?>">
      <div class="js-tabs-content">
        ...
        <div>
          <fieldset>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div >
                  <input type="hidden" name="post[head_default_pic]" id="thumb3" value="<?php echo ($config['head_default_pic']); ?>">
                  <a href="javascript:void(0);" onclick="flashuploadcut('thumb_images', '附件上传', 'thumb3', thumb_images, '1,jpg|jpeg|gif|png|bmp,1,,,1', '', '', '');return false;">
                    <?php if($config['head_default_pic'] != ''): ?><img src="<?php echo ($config['head_default_pic']); ?>" id="thumb3_preview" width="135" style="cursor: hand" />
                      <?php else: ?>
                      <img src="/default.jpg" id="thumb3_preview" width="135" style="cursor: hand" /><?php endif; ?>
                  </a>
                  <input type="button" class="btn btn-small" onclick="$('#thumb3_preview').attr('src', '/default.jpg');$('#thumb3').val('');return false;" value="取消图片">
                </div>
        ...
        <div>
          <fieldset>
            ...
            <div class="control-group">
              ...
              <div class="controls">				
                <input type="text" name="post[live_time_coin]" value="<?php echo ($config['live_time_coin']); ?>" > 计时直播收费，价格梯度用 , 分割 例：1,2,3
              </div>
            </div>
        ...
        <div>
          <fieldset>
            <div class="control-group">
              ...
              <div class="controls">				
                <input type="text" name="post[sprout_key]" value="<?php echo ($config['sprout_key']); ?>" > 留空 表示使用默认美颜
              </div>
            </div>
            <div class="control-group">
        ...
        <div>
          <fieldset>
            <div class="control-group">
              <label class="control-label">发起方底注</label>
              <div class="controls">				
                <input type="text" name="post[fq_dizhu]" value="<?php echo ($config['fq_dizhu']); ?>" >
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">美白默认值</label>
