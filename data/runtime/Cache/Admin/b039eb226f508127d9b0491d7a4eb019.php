...
<body>
	<div class="wrap">
		...
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Level/experlevel_edit_post');?>">
			<fieldset>
                ...
                <div class="control-group">
					...
					<div class="controls">
						<input type="text" name="colour" id="picker" value="<?php echo ($experlevel['colour']); ?>"> <input id="colour_block" style="width:50px;height:20px;background:#<?php echo ($experlevel['colour']); ?>;" disabled/>
