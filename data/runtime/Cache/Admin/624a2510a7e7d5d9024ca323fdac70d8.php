...
<body>
    ...
    <div class="wrap">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="<?php echo U('Jifenduihuan/privacy');?>">隐私列表</a></li>

         <!--    <li><a href="<?php echo U('Jifenduihuan/privacyadd');?>">隐私添加</a></li> -->
            ...
            <table class="table table-hover table-bordered">
                ...
                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                  ...
                  <td align="center">
                    ...
                    <a href="<?php echo U('Jifenduihuan/privacyedit',array('id'=>$vo['id']));?>" >编辑</a>
