				...
				<tbody>
					...
					<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
						...
						<td align="center">	
							...
							<a href="<?php echo U('Jifenduihuan/yongfid',array('id'=>$vo['id']));?>" >编辑</a>

							<a href="<?php echo U('Jifenduihuan/yondel',array('id'=>$vo['id']));?>"  class="js-ajax-dialog-btn" data-msg="您确定要删除吗？">删除</a>
