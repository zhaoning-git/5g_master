...
<body>
  ...
  <div class="wrap">
    ...
    <ul class="nav nav-tabs">
      ...
      <li><a href="<?php echo U('Goods/adds');?>">添加</a></li>
    ...
    <form method="post" class="js-ajax-form" action="<?php echo U('Goods/lisxiao');?>">
      ...
      <table class="table table-hover table-bordered">
        ...
        <?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
            ...
            <td>  
              <?php if($vo['status'] == '1'): ?>隐藏<?php endif; ?>
               <?php if($vo['status'] == '0'): ?>显示<?php endif; ?>
            </td>
            

            <td align="center">	

              <a href="<?php echo U('Goods/limitedit',array('id'=>$vo['id']));?>" >编辑</a>

              |

              <a href="<?php echo U('Goods/limitsdel',array('id'=>$vo['id']));?>" class="js-ajax-dialog-btn" data-msg="您确定要删除吗？">删除</a>
