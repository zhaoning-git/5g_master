...
<body>
    <div class="wrap">
        <ul class="nav nav-tabs">
            <li class="active"><a >企业机构认证列表</a></li>
        ...
        <form method="post" class="js-ajax-form" action="<?php echo U('Gift/listorders');?>">
            ...
            <table class="table table-hover table-bordered">
                ...
                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                        <td align="center"><?php echo ($vo["orid"]); ?></td>
                        <td><?php echo ($vo["operator"]); ?></td>
                     
                        <td><?php echo ($vo["information"]); ?></td>
                        <td><?php echo ($vo["location"]); ?></td>
                        <td><?php echo ($vo["organization"]); ?></td>
                        <td><?php echo ($vo["licenumber"]); ?></td>   
                        <td><?php echo ($vo["barcode"]); ?></td> 
                        <td><img src="<?php echo C('url'); echo ($vo["licenses"]); ?>" id="thumb1_preview" width="50" style="cursor: hand" /></td>
                        <td><img src="<?php echo C('url'); echo ($vo["barcodess"]); ?>" id="thumb1_preview" width="50" style="cursor: hand" /></td>
                        <td><img src="<?php echo C('url'); echo ($vo["letters"]); ?>" id="thumb1_preview" width="50" style="cursor: hand" /></td>
                        <td><?php echo ($vo["organmobile"]); ?></td>
                    ...
                    <a href="<?php echo U('Organicon/orgdit',array('id'=>$vo['orid']));?>" >编辑</a>
                    |
