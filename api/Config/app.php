...
return array(
    ...
    'Qiniu' =>  array(
        //统一的key
        'accessKey' => 'SSS_nqXLcYfxSr3hv0tMnoah17wTAH6B11aS4ieO',
        'secretKey' => 'VmWyXTcpw8xA3fcP5fFyJ9QyjM9fiKeA2KwDD6Ab',
        //自定义配置的空间
        'space_bucket' => 'ceshi',
        'space_host' => 'http://qnsanyue.mbym.xyz',
    ),
    ...
    'UCloud' => array(
        //对应的文件路径
        'host' => 'http://mbzb0515.mbym.xyz/api/upload' 
    ),
